...
# Override when publishing from a fork: export LAI_GHCR_ORG=your-org
DEFAULT_GHCR_ORG = os.environ.get("LAI_GHCR_ORG", "lulu")
...
def registry_prefix() -> str:
    return f"ghcr.io/{DEFAULT_GHCR_ORG}"
...
def default_bundle_url(version: str | None = None) -> str:
    """GitHub Release asset URL for the slim compose-only distribution bundle."""
